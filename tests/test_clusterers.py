...
def test_hdbscan_clusterer_returns_callable():
    assert callable(hdbscan_clusterer(hdbscan_kwargs={"min_cluster_size": 3}))
    assert callable(hdbscan_clusterer(hdbscan_kwargs={"min_cluster_size": 3}, threshold=0.8))


def test_hdbscan_clusterer_output_structure():
    cluster = hdbscan_clusterer(hdbscan_kwargs={"min_cluster_size": 2}, threshold=0.5)
    dim = 16
    vectors = (
...
def test_hdbscan_clusterer_separates_two_groups():
    cluster = hdbscan_clusterer(hdbscan_kwargs={"min_cluster_size": 2}, threshold=0.9)
    dim = 32
...
def test_hdbscan_clusterer_respects_min_cluster_size():
    ...
    cluster = hdbscan_clusterer(hdbscan_kwargs={"min_cluster_size": 4}, threshold=0.5)
    dim = 8
    vectors = (
